...
{
       0,   103,   103,   110,   111,   115,   121,   131,   135,   140,
     144,   149,   153,   158,   159,   168,   174,   182,   183,   188,
     189,   194,   196,   201,   207,   208,   209,   210,   211,   217,
     218,   219,   220,   223,   227,   232,   237,   238,   241,   244,
     249,   251,   253,   256,   258,   260,   262,   264,   266,   268,
     270,   272,   274,   276,   278,   281,   282,   283,   288,   289,
     291,   292,   297,   304,   305,   306,   309,   311
};
#endif
...
/* Line 936 of glr.c  */
#line 207 "parser.yy"
    { ((*yyvalp).stmt_) = new Assignst((((yyGLRStackItem const *)yyvsp)[YYFILL ((1) - (4))].yystate.yysemantics.yysval.location_),(((yyGLRStackItem const *)yyvsp)[YYFILL ((2) - (4))].yystate.yysemantics.yysval.string),(((yyGLRStackItem const *)yyvsp)[YYFILL ((3) - (4))].yystate.yysemantics.yysval.expr_)); }
    break;
...
#line 241 "parser.yy"
    { 
        ((*yyvalp).location_) = new Identifier((((yyGLRStackItem const *)yyvsp)[YYFILL ((1) - (1))].yystate.yysemantics.yysval. string )); 
        }
    break;
...
#line 244 "parser.yy"
    {
            Identifier * id = new Identifier((((yyGLRStackItem const *)yyvsp)[YYFILL ((1) - (4))].yystate.yysemantics.yysval. string ));
            ((*yyvalp).location_) = new Arrayacc(id, (((yyGLRStackItem const *)yyvsp)[YYFILL ((3) - (4))].yystate.yysemantics.yysval.expr_));
        }
    break;
...
/* Line 936 of glr.c  */
#line 249 "parser.yy"
    { ((*yyvalp).expr_) = new Location(); ((*yyvalp).expr_) = (((yyGLRStackItem const *)yyvsp)[YYFILL ((1) - (1))].yystate.yysemantics.yysval.location_); 
    }
    break;
...
/* Line 936 of glr.c  */
#line 291 "parser.yy"
    {  ((*yyvalp).expr_) = new Number(); ((*yyvalp).expr_) = (((yyGLRStackItem const *)yyvsp)[YYFILL ((1) - (1))].yystate.yysemantics.yysval.int_literal_);   }
    break;
